 ...
 * a List or Set and then make it unmodifiable or read-only by
 * using  Collections.unmodifiableList() or Collections.unmodifiableSet() method.
 *
 * @author Nkosinathi Sola
 */
public class App {
    ...
    public static void main(String args[]) {
        ...
        //contents = Collections.unmodifiableList(contents); //COMMENT/UNCOMMENT - TOGGLE THIS CODE
        ...
        //readOnlySet = Collections.unmodifiableSet(readOnlySet);//COMMENT/UNCOMMENT - TOGGLE THIS CODE
